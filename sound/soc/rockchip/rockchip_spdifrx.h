...
#define SPDIFRX_INTEN_RXOIE_MASK	BIT(5)
#define SPDIFRX_INTEN_RXOIE_EN		BIT(5)
#define SPDIFRX_INTEN_RXOIE_DIS		(0 << 5)
...
#define SPDIFRX_INTMASK_RXOIMSK		BIT(6)
#define SPDIFRX_INTMASK_RXOIUMSK	(0 << 6)
...
#define SPDIFRX_INTSR_RXOIS_ACTIVE	BIT(5)
#define SPDIFRX_INTSR_PEIS_ACTIVE	BIT(0)
...
#define SPDIFRX_INTCLR_RXOICLR_MASK	BIT(5)
#define SPDIFRX_INTCLR_RXOICLR		BIT(5)
