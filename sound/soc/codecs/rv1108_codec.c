 ...
 * step: 1.5db
 */
#define CAP_VOLUME_L	21
#define CAP_VOLUME_R	21
...
static struct rv1108_reg_msk_val capture_open_list[] = {
	...
	{ RV1108_ALCL_GAIN_CTL, RV1108_ALCL_GAIN_MSK, CAP_VOLUME_L },
	{ RV1108_ALCR_GAIN_CTL, RV1108_ALCR_GAIN_MSK, CAP_VOLUME_R },
};
