...
#if defined(CONFIG_ROCKCHIP_IOVMMU) & defined(CONFIG_ION_ROCKCHIP)
...
{
	queue_delayed_work(delay_work_queue, &pservice->power_off_work, VPU_POWER_OFF_DELAY);
}
...
static int vcodec_probe(struct platform_device *pdev)
{
    ...
    pr_info("reg_base %x\n", (unsigned int) pservice->reg_base);
