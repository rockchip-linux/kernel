...
static struct device_attribute display_attrs[] = {
	...
	__ATTR(enable, S_IRUGO | S_IWUSR,
	       display_show_enable, display_store_enable),
	__ATTR(connect, S_IRUGO, display_show_connect, NULL),
	__ATTR(modes, S_IRUGO, display_show_modes, NULL),
	__ATTR(mode, S_IRUGO | S_IWUSR,
	       display_show_mode, display_store_mode),
	__ATTR(scale, S_IRUGO | S_IWUSR,
	       display_show_scale, display_store_scale),
	__ATTR(3dmode, S_IRUGO | S_IWUSR,
	       display_show_3dmode, display_store_3dmode),
	__ATTR(color, S_IRUGO | S_IWUSR,
	       display_show_color, display_store_color),
