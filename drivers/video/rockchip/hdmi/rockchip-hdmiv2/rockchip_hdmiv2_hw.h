...
#define EXT_PHY_TERM_RESIS_AUTO		0xf4
	...
	#define EXT_PHY_MANAUL_150_OHMS			(BIT(7) | BIT(4))
...
#define RK322XH_IO_CTRL_BY_GRF	0xf000f000
#define RK322XH_IO_CTRL_BY_HDMI	(0xf0000000 | BIT(13) | BIT(12))
#define RK322XH_IO_5V_DOMAIN	((7 << 9) | (3 << (9 + 16)))
