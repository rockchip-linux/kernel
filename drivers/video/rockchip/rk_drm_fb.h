...
struct rk_drm_display {
	...
	void (*event_call_back)(struct rk_drm_display *drm_disp, int win_id,
				int event);
};
...
extern int rk_drm_disp_handle(struct rk_drm_display *drm_disp,
			      unsigned int win_id, unsigned int cmd_id);
