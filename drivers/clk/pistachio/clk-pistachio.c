...
static struct pistachio_div pistachio_divs[] __initdata = {
	...
	DIV(CLK_AUDIO_DIV, "audio_div", "audio_mux", 0x20c, 8),
	DIV(CLK_I2S_DIV, "i2s_div", "audio_pll_mux", 0x210, 8),
	DIV(CLK_SPDIF_DIV, "spdif_div", "audio_pll_mux", 0x214, 8),
	DIV(CLK_AUDIO_DAC_DIV, "audio_dac_div", "audio_pll_mux", 0x218, 8),
...
static struct pistachio_div pistachio_periph_divs[] __initdata = {
	...
	DIV_F(PERIPH_CLK_IR_PRE_DIV, "ir_pre_div", "periph_sys_core", 0x11c, 7,
	      CLK_DIVIDER_ROUND_CLOSEST),
	DIV_F(PERIPH_CLK_IR_DIV, "ir_div", "ir_pre_div", 0x120, 7,
	      CLK_DIVIDER_ROUND_CLOSEST),
	DIV_F(PERIPH_CLK_WD_PRE_DIV, "wd_pre_div", "periph_sys_core", 0x124, 7,
	      CLK_DIVIDER_ROUND_CLOSEST),
