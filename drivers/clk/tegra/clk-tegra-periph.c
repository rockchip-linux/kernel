...
static struct tegra_periph_init_data periph_clks[] = {
	...
	MUX("afc0", mux_plla_pllc_pllp_clkm, CLK_SOURCE_AMX1, 186, TEGRA_PERIPH_ON_APB, tegra_clk_afc0),
	MUX("afc1", mux_plla_pllc_pllp_clkm, CLK_SOURCE_AMX1, 187, TEGRA_PERIPH_ON_APB, tegra_clk_afc1),
	MUX("afc2", mux_plla_pllc_pllp_clkm, CLK_SOURCE_AMX1, 188, TEGRA_PERIPH_ON_APB, tegra_clk_afc2),
	MUX("afc3", mux_plla_pllc_pllp_clkm, CLK_SOURCE_AMX1, 189, TEGRA_PERIPH_ON_APB, tegra_clk_afc3),
