...
#define RK3228_CORE_CLK_PLL_SEL_SHIFT	(6)
#define RK3228_CORE_CLK_PLL_SEL_MASK	(0x3)
#define RK3228_CPU_SEL_PLL(plls)	CRU_W_MSK_SETBITS(plls, RK3228_CORE_CLK_PLL_SEL_SHIFT, RK3228_CORE_CLK_PLL_SEL_MASK)
...
/***************************RV1108 PLL**************************************/
#define RV1108_CORE_CLK_PLL_SEL_SHIFT	(8)
#define RV1108_CORE_CLK_PLL_SEL_MASK	(0x3)
#define RV1108_CPU_SEL_PLL(plls)	CRU_W_MSK_SETBITS(plls, RV1108_CORE_CLK_PLL_SEL_SHIFT, RV1108_CORE_CLK_PLL_SEL_MASK)

#define RV1108_PLL_FBDIV_MASK		(0xfff)
#define RV1108_PLL_FBDIV_SHIFT		(0)

#define RV1108_PLL_REFDIV_MASK		(0x3f)
#define RV1108_PLL_REFDIV_SHIFT		(0)
#define RV1108_PLL_POSTDIV1_MASK	(0x7)
#define RV1108_PLL_POSTDIV1_SHIFT	(8)
#define RV1108_PLL_POSTDIV2_MASK	(0x7)
#define RV1108_PLL_POSTDIV2_SHIFT	(12)

#define RV1108_PLL_FRAC_MASK		(0xffffff)
#define RV1108_PLL_FRAC_SHIFT		(0)

#define RV1108_PLL_DSMPD_SHIFT		(3)

#define RV1108_PLL_SET_REFDIV(val)	CRU_W_MSK_SETBITS(val, RV1108_PLL_REFDIV_SHIFT, RV1108_PLL_REFDIV_MASK)
#define RV1108_PLL_SET_FBDIV(val)	CRU_W_MSK_SETBITS(val, RV1108_PLL_FBDIV_SHIFT, RV1108_PLL_FBDIV_MASK)
#define RV1108_PLL_SET_POSTDIV1(val)	CRU_W_MSK_SETBITS(val, RV1108_PLL_POSTDIV1_SHIFT, RV1108_PLL_POSTDIV1_MASK)
#define RV1108_PLL_SET_POSTDIV2(val)	CRU_W_MSK_SETBITS(val, RV1108_PLL_POSTDIV2_SHIFT, RV1108_PLL_POSTDIV2_MASK)
#define RV1108_PLL_SET_FRAC(val)	CRU_SET_BITS(val, RV1108_PLL_FRAC_SHIFT, RV1108_PLL_FRAC_MASK)

#define RV1108_PLL_GET_REFDIV(reg)	CRU_GET_REG_BITS_VAL(reg, RV1108_PLL_REFDIV_SHIFT, RV1108_PLL_REFDIV_MASK)
#define RV1108_PLL_GET_FBDIV(reg)	CRU_GET_REG_BITS_VAL(reg, RV1108_PLL_FBDIV_SHIFT, RV1108_PLL_FBDIV_MASK)
#define RV1108_PLL_GET_POSTDIV1(reg)	CRU_GET_REG_BITS_VAL(reg, RV1108_PLL_POSTDIV1_SHIFT, RV1108_PLL_POSTDIV1_MASK)
#define RV1108_PLL_GET_POSTDIV2(reg)	CRU_GET_REG_BITS_VAL(reg, RV1108_PLL_POSTDIV2_SHIFT, RV1108_PLL_POSTDIV2_MASK)
#define RV1108_PLL_GET_FRAC(reg)	CRU_GET_REG_BITS_VAL(reg, RV1108_PLL_FRAC_SHIFT, RV1108_PLL_FRAC_MASK)

#define RV1108_PLL_SET_DSMPD(val)	CRU_W_MSK_SETBIT(val, RV1108_PLL_DSMPD_SHIFT)
#define RV1108_PLL_GET_DSMPD(reg)	CRU_GET_REG_BIT_VAL(reg, RV1108_PLL_DSMPD_SHIFT)

#define RV1108_ACLK_CORE_DIV_MASK	(0x7)
#define RV1108_ACLK_CORE_DIV_SHIFT	(0)
#define RV1108_PCLK_DBG_DIV_MASK	(0xf)
#define RV1108_PCLK_DBG_DIV_SHIFT	(4)

#define RV1108_ACLK_CORE_DIV(val)	CRU_W_MSK_SETBITS(val - 1, RV1108_ACLK_CORE_DIV_SHIFT, RV1108_ACLK_CORE_DIV_MASK)
#define RV1108_PCLK_DBG_DIV(val)	CRU_W_MSK_SETBITS(val - 1, RV1108_PCLK_DBG_DIV_SHIFT, RV1108_PCLK_DBG_DIV_MASK)

#define _RV1108_APLL_SET_CLKS(_mhz, _refdiv, _fbdiv, _postdiv1, _postdiv2, _dsmpd, _frac, \
		aclk_core_div, pclk_dbg_div) \
{ \
	.rate	= (_mhz) * MHZ,	\
	.pllcon0 = RV1108_PLL_SET_FBDIV(_fbdiv),	\
	.pllcon1 = RV1108_PLL_SET_POSTDIV1(_postdiv1) | RV1108_PLL_SET_POSTDIV2(_postdiv2) | RV1108_PLL_SET_REFDIV(_refdiv),	\
	.pllcon2 = RV1108_PLL_SET_FRAC(_frac),	\
	.pllcon3 = RV1108_PLL_SET_DSMPD(_dsmpd),	\
	.clksel1 = RV1108_ACLK_CORE_DIV(aclk_core_div) | RV1108_PCLK_DBG_DIV(pclk_dbg_div),	\
	.lpj	= (CLK_LOOPS_JIFFY_REF * _mhz) / CLK_LOOPS_RATE_REF,	\
	.rst_dly = 0,\
}

#define _RV1108_PLL_SET_CLKS(_mhz, _refdiv, _fbdiv, _postdiv1, _postdiv2, _dsmpd, _frac) \
{ \
	.rate	= (_mhz) * KHZ, \
	.pllcon0 = RV1108_PLL_SET_FBDIV(_fbdiv),	\
	.pllcon1 = RV1108_PLL_SET_POSTDIV1(_postdiv1) | RV1108_PLL_SET_POSTDIV2(_postdiv2) | RV1108_PLL_SET_REFDIV(_refdiv),	\
