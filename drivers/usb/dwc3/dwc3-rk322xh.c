/**
 * dwc3-rk322xh.c - Rockchip rk322xh SoC DWC3 Specific Glue layer
...
static int dwc3_rockchip_probe(struct platform_device *pdev)
{
	...
	if (rockchip->phy) {
		...
		rockchip->u3phy_nb.notifier_call = u3phy_disconnect_det_notifier;
...
MODULE_ALIAS("platform:rk322xh-dwc3");
MODULE_AUTHOR("William Wu <william.wu@rock-chips.com>");
MODULE_LICENSE("GPL v2");
MODULE_DESCRIPTION("DesignWare USB3 rk322xh Glue Layer");
