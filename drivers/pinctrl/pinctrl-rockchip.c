...
static void rockchip_irq_suspend(struct irq_data *d)
{
	...
	bank->saved_masks = irq_reg_readl(gc->reg_base + GPIO_INTMASK);
	irq_reg_writel(~gc->wake_active, gc->reg_base + GPIO_INTMASK);
}
...
static void rockchip_irq_resume(struct irq_data *d)
{
	...
	irq_reg_writel(bank->saved_masks, gc->reg_base + GPIO_INTMASK);
}
