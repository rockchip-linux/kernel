...
#ifndef _CIF_CIF10_IMG_SRC_H
#define _CIF_CIF10_IMG_SRC_H
...
struct cif_cif10_img_src_ctrl {
	unsigned int id;
	int val;
};

struct cif_cif10_img_src_ext_ctrl {
	int cnt;
	unsigned int class;
	struct cif_cif10_img_src_ctrl *ctrls;
};
...
int cif_cif10_img_src_s_ext_ctrls(
	struct cif_cif10_img_src *img_src,
	struct cif_cif10_img_src_ext_ctrl *ctrls);
