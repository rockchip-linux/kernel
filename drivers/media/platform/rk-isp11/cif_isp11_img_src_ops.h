...
#ifndef _CIF_ISP11_IMG_SRC_OPS_H
...
const struct {
	...
	struct cif_isp11_img_src_ops ops;
} cif_isp11_img_src_ops[] = {
	{
		.device_type = CIF_ISP11_IMG_SRC_V4L2_I2C_SUBDEV,
		.ops = {
			.to_img_src =
			...
			.enum_strm_fmts =
				cif_isp11_img_src_v4l2_subdev_enum_strm_fmts,
			.s_strm_fmt =
				cif_isp11_img_src_v4l2_subdev_s_strm_fmt,
			.g_ctrl =
				cif_isp11_img_src_v4l2_subdev_g_ctrl,
			.g_name =
				cif_isp11_img_src_v4l2_subdev_g_name,
			.s_ctrl =
				cif_isp11_img_src_v4l2_subdev_s_ctrl,
			.s_ext_ctrls =
				cif_isp11_img_src_v4l2_subdev_s_ext_ctrls,
			.ioctl =
				cif_isp11_img_src_v4l2_subdev_ioctl,
			.s_frame_interval =
				cif_isp11_img_src_v4l2_subdev_s_frame_interval,
			.g_frame_interval =
