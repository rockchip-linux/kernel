...
#ifndef _RK_CIF_ISP11_REGS_H
#define _RK_CIF_ISP11_REGS_H
...
#define CIF_ISP_CTRL_ISP_CFG_UPD_PERMANENT      (1<<8)
...
#define CIF_ISP_CTRL_ISP_GAMMA_OUT_12BIT_EN    (1<<19)
#define CIF_ISP_CTRL_ISP_Y12_Y_OUT_EN          (1<<24)
#define CIF_ISP_CTRL_ISP_Y12_UV_OUT_EN         (1<<25)
#define CIF_ISP_CTRL_ISP_RGB_OUT_SEL           (1<<26)
...
#define CIF_ISP_ACQ_PROP_Y12_UV_DS_MODE_YUV420 (0<<19)
#define CIF_ISP_ACQ_PROP_Y12_UV_DS_MODE_YUV422 (1<<19)
#define CIF_ISP_ACQ_PROP_Y12_UV_DOWN_SAMPLE    (0<<17)
...
#define CIF_ISP_HIST_MEASURE_RDY      (1<<15)
#define CIF_ISP_FLASH_CAP                  (1<<17)
#define CIF_ISP_EXP_END                    (1<<18)
#define CIF_ISP_VSM_END                   (1<<19)

/* ISP_ERR */
#define CIF_ISP_ERR_INFORM_SIZE		(1 << 0)
#define CIF_ISP_ERR_IS_SIZE		(1 << 1)
#define CIF_ISP_ERR_OUTFORM_SIZE	(1 << 2)

/* MI_CTRL */
#define CIF_MI_CTRL_MP_ENABLE_IN           (1<<0)
#define CIF_MI_CTRL_MP_ENABLE_OUT          (1<<16)
...
#define CIF_MI_SP_Y_FULL_YUV2RGB                 (1 << 8)
#define CIF_MI_SP_Y_REDUCED_YUV2RGB          (0 << 8)
#define CIF_MI_SP_CBCR_FULL_YUV2RGB                 (1 << 9)
#define CIF_MI_SP_CBCR_REDUCED_YUV2RGB          (0 << 9)
#define CIF_MI_SP_422NONCOSITEED              (1 << 10)
#define CIF_MI_MP_PINGPONG_ENABEL          (1 << 11)
#define CIF_MI_MP_PINGPONG_DISABEL         (0 << 11)
#define CIF_MI_SP_PINGPONG_ENABEL          (1 << 12)
#define CIF_MI_SP_PINGPONG_DISABEL         (0 << 12)
#define CIF_MI_MP_AUTOUPDATE_ENABLE     (1 << 13)
#define CIF_MI_MP_AUTOUPDATE_DISABLE    (0 << 13)
#define CIF_MI_SP_AUTOUPDATE_ENABLE     (1 << 14)
#define CIF_MI_SP_AUTOUPDATE_DISABLE    (0 << 14)
#define CIF_MI_LAST_PIXEL_SIG_ENABLE        (1 << 15)
...
#define CIF_RSZ_CTRL_CFG_UPD_AUTO   (1<<9)
#define CIF_RSZ_SCALER_BYPASS	(1<<16)
...
#define CIF_MI_Y12_Y_FRAME                 (1<<12)
#define CIF_MI_Y12_UV_FRAME                (1<<13)
#define CIF_MI_ALL_FRAME                   (1<<14)
...
/* MI_XTD_FORMAT_CTRL  */
#define CIF_MI_XTD_FMT_CTRL_MP_CB_CR_SWAP	(1<<0)
#define CIF_MI_XTD_FMT_CTRL_SP_CB_CR_SWAP		(1<<1)
#define CIF_MI_XTD_FMT_CTRL_DMA_CB_CR_SWAP	(1<<2)
#define CIF_MI_XTD_FMT_CTRL_Y12_CB_CR_SWAP	(1<<3)
...
#define CIF_C_PROC_YOUT_FULL                 (1<<1)
#define CIF_C_PROC_YOUT_LIM          (0<<1)
#define CIF_C_PROC_YIN_FULL                 (1<<2)
#define CIF_C_PROC_YIN_LIM         (0<<2)
#define CIF_C_PROC_COUT_FULL                 (1<<3)
...
#define CIF_DUAL_CROP_CFG_UPD_PERMANENT		(1 << 4)
#define CIF_DUAL_CROP_CFG_UPD			(1 << 5)
#define CIF_DUAL_CROP_GEN_CFG_UPD		(1 << 6)
...
#define CIF_IMG_EFF_CTRL_YCBCR_FULL       (1<<5)
...
#define CIF_MIPI_CTRL_CLOCKLANE_ENA               (1<<18)
...
#define CIF_ISP_WDR_CTRL0 (CIF_ISP_WDR_BASE + 0x00000150)
#define CIF_ISP_WDR_CTRL1 (CIF_ISP_WDR_BASE + 0x00000154)
#define CIF_ISP_WDR_BLKOFF (CIF_ISP_WDR_BASE + 0x00000158)
#define CIF_ISP_WDR_AVG_CLIP (CIF_ISP_WDR_BASE + 0x0000015C)
#define CIF_ISP_WDR_COE_0 (CIF_ISP_WDR_BASE + 0x00000160)
#define CIF_ISP_WDR_COE_1 (CIF_ISP_WDR_BASE + 0x00000164)
#define CIF_ISP_WDR_COE_2 (CIF_ISP_WDR_BASE + 0x00000168)
#define CIF_ISP_WDR_COE_OFF (CIF_ISP_WDR_BASE + 0x0000016C)
