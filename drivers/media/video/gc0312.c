...
#define SENSOR_ID 0xb310	// high 0xb3  low 0x10
...
static struct rk_sensor_reg sensor_init_data[] = {
...
#if 0
	case GC0312MIPI_RGB_Gamma_m1: //smallest gamma curve
		{0xfe, 0x00},
		{0xbf, 0x06},
		{0xc0, 0x12},
		{0xc1, 0x22},
	...
	case GC0312MIPI_RGB_Gamma_m6: // largest gamma curve
		{0xBF, 0x14},
		{0xc0, 0x28},
		{0xc1, 0x44},
		{0xc2, 0x5D},
	...
	case GC0312MIPI_RGB_Gamma_night: //Gamma for night mode
		{0xBF, 0x0B},
		{0xc0, 0x16},
		{0xc1, 0x29},
		{0xc2, 0x3C},
