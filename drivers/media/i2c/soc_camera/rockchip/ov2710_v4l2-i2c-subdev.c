...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3011, 0x09},
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380f, 0xa2},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4837, 0x19},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4819, 0xc6},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4823, 0x5c},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3500, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3501, 0x23},
...
static struct ov_camera_module_config ov2710_configs[] = {
	{
		...
		/*.set_exposure = {
			...
			.set_valid_type = CAMERA_MODULE_SET_EXPOSURE_ORDER_TIME
		}*/
	}
};
