...
static struct ov_camera_module_reg ov8858_init_tab_3264_2448_18fps[] = {
/*global setting*/
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4821, 0x5f}, /* add it for clk_post */
...
/* ;;pll1_VCO= 962, pll_MIPIclk=481Mbps, mipi_Pclk =60.125, Sclk1=120.25 */
...
#if 0
/* MCLK:26MHz  3264x2448  18fps   mipi 4lane   481Mbps/lane */
static struct ov_camera_module_reg ov8858_init_tab_3264_2448_18fps_diff[] = {
/* @@ SIZE_3264X2448_15FPS_MIPI_4LANE based on R2A_EN_AM22 version db*/
/* ;;pll2_VCO= 721.5, SYSclk=144.3, Dac_clk =360.75 */
/* ;;pll1_VCO= 962, pll_MIPIclk=481Mbps, mipi_Pclk =60.125, Sclk1=120.25 */
/* ;;fps=15, 10bit,4lane, Vblanking=7.251ms */
...
#endif
static const struct ov_camera_module_reg ov8858_init_tab_1632_1224_30fps_R1A[] = {
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0103, 0x01},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
...
static const struct ov_camera_module_reg ov8858_init_tab_3264_2448_15fps_R1A[] =  {
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0103, 0x01},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
...
#if 0
/* MCLK:26MHz  1632x1244  30fps   mipi 4lane   364Mbps/lane */
static struct ov_camera_module_reg ov8858_init_tab_1632_1224_30fps[] = {
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0103, 0x01},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0300, 0x05},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0301, 0x00},
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3815, 0x01},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3820, 0x06},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3821, 0x61},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382a, 0x03},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382b, 0x01},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3830, 0x08},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3836, 0x02},
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4500, 0x58},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3021, 0x23},
/* @@ SIZE_1632X1224_30FPS_MIPI_4LANE based on R2A_EN_AM22 version db*/
/* ;;pll2_VCO= 721.5, SYSclk=144.3, Dac_clk =360.75 */
/* ;;pll1_VCO= 962, pll_MIPIclk=481Mbps, mipi_Pclk =60.125, Sclk1=120.25 */
/* ;;fps=30, 10bit,4lane, vblanking=8.693ms */
/* ;;update on 2015/06/25*/
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3808, 0x06},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3809, 0x60},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380a, 0x04},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380b, 0xc8},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380c, 0x0b},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380d, 0x58},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380e, 0x06},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380f, 0x78},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3814, 0x03},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3821, 0x61},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382a, 0x03},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382d, 0x7f},
...
static struct ov_camera_module_reg ov8858_init_tab_1632_1224_30fps_diff[] = {
/* @@ SIZE_1632X1224_30FPS_MIPI_4LANE based on R2A_EN_AM22 version db*/
/* ;;pll2_VCO= 721.5, SYSclk=144.3, Dac_clk =360.75 */
/* ;;pll1_VCO= 962, pll_MIPIclk=481Mbps, mipi_Pclk =60.125, Sclk1=120.25 */
/* ;;fps=30, 10bit,4lane, vblanking=8.693ms */
...
static struct ov_camera_module_reg ov8858_init_tab_3200_1800_25fps[] = {
/*global setting*/
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0103, 0x01},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0100, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0300, 0x05},
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4500, 0x58},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3021, 0x23},
/* @@ SIZE_3200x1800_25FPS_MIPI_4LANE based on R2A_EN_AM22 version db*/
/* ;;pll2_VCO= 721.5, SYSclk=144.3, Dac_clk =360.75 */
/* ;;pll1_VCO= 962, pll_MIPIclk=481Mbps, mipi_Pclk =60.125, Sclk1=120.25 */
/* ;;fps=25, 10bit,4lane, vblanking=8.0ms */
/* ;;update on 2015/06/25*/
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3808, 0x0c},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3809, 0x80},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380a, 0x07},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380b, 0x08},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380c, 0x09},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380d, 0xf0},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380e, 0x08},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380f, 0xd7},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3814, 0x01},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3821, 0x40},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382a, 0x01},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382d, 0xff},
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4001, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4022, 0x0c},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4023, 0x20},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4025, 0x36},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4027, 0x37},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x402b, 0x08},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x402f, 0x08},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4500, 0x58},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4600, 0x00},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4601, 0xc7},
};

static struct ov_camera_module_reg ov8858_init_tab_3200_1800_25fps_diff[] = {
/* @@ SIZE_3200x1800_25FPS_MIPI_4LANE based on R2A_EN_AM22 version db*/
/* ;;pll2_VCO= 721.5, SYSclk=144.3, Dac_clk =360.75 */
/* ;;pll1_VCO= 962, pll_MIPIclk=481Mbps, mipi_Pclk =60.125, Sclk1=120.25 */
/* ;;fps=25, 10bit,4lane, vblanking=8.0ms */
...
static struct ov_camera_module_config ov8858_configs[] = {
	/*{
		...
		.reg_diff_table = (void *)ov8858_init_tab_1632_1224_30fps_diff,
		.reg_diff_table_num_entries =
			sizeof(ov8858_init_tab_1632_1224_30fps_diff)
			/
			sizeof(ov8858_init_tab_1632_1224_30fps_diff[0]),
		.v_blanking_time_us = 8693,
		PLTFRM_CAM_ITF_MIPI_CFG(0,4,481)
	},
	{
		.name = "3200x1800_25fps",
		.frm_fmt = {
			.width = 3200,
			.height = 1800,
			.code = V4L2_MBUS_FMT_SBGGR10_1X10
		...
		.auto_gain_enabled = false,
		.auto_wb_enabled = false,
		.reg_table = (void *)ov8858_init_tab_3200_1800_25fps,
		.reg_table_num_entries =
			sizeof(ov8858_init_tab_3200_1800_25fps)
			/
			sizeof(ov8858_init_tab_3200_1800_25fps[0]),
		.reg_diff_table = (void *)ov8858_init_tab_3200_1800_25fps_diff,
		.reg_diff_table_num_entries =
			sizeof(ov8858_init_tab_3200_1800_25fps_diff)
			/
			sizeof(ov8858_init_tab_3200_1800_25fps_diff[0]),
		.v_blanking_time_us = 8000,
		PLTFRM_CAM_ITF_MIPI_CFG(0,4,481)
	},*/
	{
	...
	int len)
{
	...
	if (!IS_ERR_OR_NULL(cam_mod->active_config)) {
		...
		case ov8858_FULL_SIZE_RESOLUTION_WIDTH:
			...
			break;
		case ov8858_VIDEO_SIZE_RESOLUTION_WIDTH:
			if (mode == OV_FLIP_BIT_MASK) {
				match_reg[0] = 0x06;
				match_reg[1] = 0x40;
			} else if (mode == OV_MIRROR_BIT_MASK) {
			...
			break;
		case ov8858_BINING_SIZE_RESOLUTION_WIDTH:
			if (mode == OV_FLIP_BIT_MASK) {
				match_reg[0] = 0x06;
				match_reg[1] = 0x61;
			} else if (mode == OV_MIRROR_BIT_MASK) {
		...
		for (i = len; i > 0; i--) {
			if (reglist[i].reg == ov8858_FLIP_REG)
				reglist[i].val = match_reg[0];
			else if (reglist[i].reg == ov8858_MIRROR_REG)
...
int  __ov8858_read_otp_wb(struct ov_camera_module *cam_mod)
{
	...
	if (addr != 0) {
		...
		ret |= ov_camera_module_read_reg(cam_mod, 1, (addr+5), &temp1);
		ret |= ov_camera_module_read_reg(cam_mod, 1, (addr+7), &temp2);
		otp_ptr->rg_ratio = (temp1 << 2)+(temp2 >> 6 & 0x03);
		ret |= ov_camera_module_read_reg(cam_mod, 1, (addr+6), &temp1);
...
int  __ov8858_read_otp_vcm(struct ov_camera_module *cam_mod)
{
	...
	if (addr != 0) {
		...
		ret |= ov_camera_module_read_reg(cam_mod, 1, (addr+2), &temp2);
		otp_ptr->VCM_start = (temp1 << 2)|(temp1 >> 6 & 0x03);
		ret |= ov_camera_module_read_reg(cam_mod, 1, (addr+1), &temp1);
