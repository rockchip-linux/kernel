...
void mc3230_write_0x20(u8 value)
{
	sensor_write_reg(g_client, 0x20, value);
}
void mc3230_dump_reg(void)
{
	u8 reg = 0;
	struct i2c_client;
...
void mc3230_active_test(u8 bflag)
{
	if (g_client == NULL)
		return;

	sensor_active(g_client, bflag, 0xff);
}
