...
#define RK_SERVICE_MSCH_VIRT		RK_IO_ADDRESS(0x000e0000)
...
#define RK322X_IMEM_PHYS		RK3036_IMEM_PHYS
#define RK322X_IMEM_SIZE		SZ_32K
#define RK322X_ROM_PHYS			RK3036_ROM_PHYS
#define RK322X_ROM_SIZE			RK3036_ROM_SIZE
#define RK322X_CPU_AXI_BUS_PHYS		0x31000000
#define RK322X_CPU_AXI_BUS_SIZE		SZ_32K
#define RK322X_GIC_DIST_PHYS		0x32011000
#define RK322X_GIC_DIST_SIZE		SZ_4K
#define RK322X_GIC_CPU_PHYS		0x32012000
#define RK322X_GIC_CPU_SIZE		SZ_4K
#define RK322X_CRU_PHYS			0x110e0000
#define RK322X_CRU_SIZE			SZ_4K
#define RK322X_DDR_PCTL_PHYS		0x11200000
#define RK322X_DDR_PCTL_SIZE		SZ_4K
#define RK322X_GRF_PHYS			0x11000000
#define RK322X_GRF_SIZE			SZ_4K
#define RK322X_SGRF_PHYS		0x10140000
#define RK322X_SGRF_SIZE		SZ_4K
#define RK322X_DDR_PHY_PHYS		0x12000000
#define RK322X_DDR_PHY_SIZE		SZ_4K
#define RK322X_TIMER_PHYS		0x110c0000
#define RK322X_TIMER_SIZE		SZ_4K
#define RK322X_STIMER_PHYS		0x110d0000
#define RK322X_STIMER_SIZE		SZ_4K
#define RK322X_UART0_PHYS		0x11010000
#define RK322X_UART1_PHYS		0x11020000
#define RK322X_UART2_PHYS		0x11030000
#define RK322X_UART_SIZE		SZ_4K
#define RK322X_GPIO0_PHYS		0x11110000
#define RK322X_GPIO1_PHYS		0x11120000
#define RK322X_GPIO2_PHYS		0x11130000
#define RK322X_GPIO3_PHYS		0x11140000
#define RK322X_GPIO_SIZE		SZ_4K
#define RK322X_EFUSE_PHYS		0x11040000
#define RK322X_EFUSE_SIZE		SZ_4K
#define RK322X_PWM_PHYS			0x110b0000
#define RK322X_PWM_SIZE			SZ_16K

#define RV1108_IMEM_PHYS		RK3036_IMEM_PHYS
#define RV1108_IMEM_SIZE		SZ_32K
#define RV1108_ROM_PHYS			RK3036_ROM_PHYS
#define RV1108_ROM_SIZE			RK3036_ROM_SIZE
#define RV1108_UART2_PHYS		0x10210000
#define RV1108_UART1_PHYS		0x10220000
#define RV1108_UART0_PHYS		0x10230000
#define RV1108_UART_SIZE		SZ_4K
#define RV1108_PWM_PHYS			0x10280000
#define RV1108_PWM_SIZE			SZ_16K
#define RV1108_GRF_PHYS			0x10300000
#define RV1108_GRF_SIZE			SZ_4K
#define RV1108_GPIO0_PHYS		0x20030000
#define RV1108_GPIO1_PHYS		0x10310000
#define RV1108_GPIO2_PHYS		0x10320000
#define RV1108_GPIO3_PHYS		0x10330000
#define RV1108_GPIO_SIZE		SZ_4K
#define RV1108_EFUSE_PHYS		0x10340000
#define RV1108_EFUSE_SIZE		SZ_4K
#define RV1108_TIMER_PHYS		0x10350000
#define RV1108_TIMER_SIZE		SZ_4K
#define RV1108_PMU_PHYS			0x20010000
#define RV1108_PMU_SIZE			SZ_4K
#define RV1108_PMU_MEM_PHYS		0x20020000
#define RV1108_PMU_MEM_SIZE		SZ_4K
#define RV1108_PMU_GRF_PHYS		0x20060000
#define RV1108_PMU_GRF_SIZE		SZ_4K
#define RV1108_CRU_PHYS			0x20200000
#define RV1108_CRU_SIZE			SZ_4K
#define RV1108_DDR_PHY_PHYS		0x20210000
#define RV1108_DDR_PHY_SIZE		SZ_4K
#define RV1108_DDR_PCTL_PHYS		0x202b0000
#define RV1108_DDR_PCTL_SIZE		SZ_4K
#define RV1108_CPU_AXI_BUS_PHYS		0x31000000
#define RV1108_CPU_AXI_BUS_SIZE		SZ_32K
#define RV1108_SERVICE_MSCH_PHYS	0x31070000
#define RV1108_SERVICE_MSCH_SIZE	SZ_32K
#define RV1108_GIC_DIST_PHYS		0x32011000
#define RV1108_GIC_DIST_SIZE		SZ_4K
#define RV1108_GIC_CPU_PHYS		0x32012000
#define RV1108_GIC_CPU_SIZE		SZ_4K
