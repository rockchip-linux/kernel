...
/* rv1108 */
#define RV1108_CRU_APLL_CON3		0x000c
#define RV1108_CRU_DPLL_CON3		0x002c
#define RV1108_CRU_GPLL_CON3		0x004c
#define RV1108_CRU_GLB_SRST_FST_VALUE	0x01c0
#define RV1108_CRU_GLB_SRST_SND_VALUE	0x01c4
#define RV1108_CRU_GLB_CNT_TH		0x01c8
#define RV1108_CRU_MISC_CON		0x01cc
#define RV1108_CRU_GLB_RST_CON		0x01d0
#define RV1108_CRU_GLB_RST_ST		0x01d4
#define RV1108_CRU_SDMMC_CON0		0x01d8
#define RV1108_CRU_SDMMC_CON1		0x01dc
#define RV1108_CRU_SDIO_CON0		0x01e0
#define RV1108_CRU_SDIO_CON1		0x01e4
#define RV1108_CRU_EMMC_CON0		0x01e8
#define RV1108_CRU_EMMC_CON1		0x01ec

#define RV1108_PLL_CONS(id, i)		((id) * 0x20 + ((i) * 4))
#define RV1108_PLLS_MODE_OFFSET		(8)

#define RV1108_CRU_CLKSEL_CON		0x60
#define RV1108_CRU_CLKSELS_CON_CNT	(46)
#define RV1108_CRU_CLKSELS_CON(i)	(RV1108_CRU_CLKSEL_CON + ((i) * 4))

#define RV1108_CRU_CLKGATE_CON		0x0120
#define RV1108_CRU_CLKGATES_CON_CNT	(20)
#define RV1108_CRU_CLKGATES_CON(i)	(RV1108_CRU_CLKGATE_CON + ((i) * 4))

#define RV1108_CRU_SOFTRST_CON		0x0180
...
enum rv1108_cru_clk_gate {
	/* SCU CLK GATE 0 CON */
	RV1108_CLKGATE_UART0_SRC = (RV1108_CRU_CONS_GATEID(3) + 1),
	RV1108_CLKGATE_UART1_SRC = (RV1108_CRU_CONS_GATEID(3) + 3),
	RV1108_CLKGATE_UART2_SRC = (RV1108_CRU_CONS_GATEID(3) + 5),
	RV1108_CLKGATE_PCLK_UART0 = (RV1108_CRU_CONS_GATEID(13) + 10),
	RV1108_CLKGATE_PCLK_UART1,
	RV1108_CLKGATE_PCLK_UART2,
};
