...
#define RK1108_CRU_GLB_CNT_TH		0x01c8
#define RK1108_CRU_MISC_CON		0x01cc
#define RK1108_CRU_GLB_RST_CON		0x01d0
#define RK1108_CRU_GLB_RST_ST		0x01d4
#define RK1108_CRU_SDMMC_CON0		0x01d8
#define RK1108_CRU_SDMMC_CON1		0x01dc
#define RK1108_CRU_SDIO_CON0		0x01e0
#define RK1108_CRU_SDIO_CON1		0x01e4
#define RK1108_CRU_EMMC_CON0		0x01e8
#define RK1108_CRU_EMMC_CON1		0x01ec

#define RK1108_PLL_CONS(id, i)		((id) * 0x20 + ((i) * 4))
#define RK1108_PLLS_MODE_OFFSET		(8)

#define RK1108_CRU_CLKSEL_CON		0x60
#define RK1108_CRU_CLKSELS_CON_CNT	(46)
#define RK1108_CRU_CLKSELS_CON(i)	(RK1108_CRU_CLKSEL_CON + ((i) * 4))

#define RK1108_CRU_CLKGATE_CON		0x0120
#define RK1108_CRU_CLKGATES_CON_CNT	(20)
#define RK1108_CRU_CLKGATES_CON(i)	(RK1108_CRU_CLKGATE_CON + ((i) * 4))

#define RK1108_CRU_SOFTRST_CON		0x0180
#define RK1108_CRU_SOFTRSTS_CON_CNT	(13)
#define RK1108_CRU_SOFTRSTS_CON(i)	(RK1108_CRU_SOFTRST_CON + ((i) * 4))

#define RK1108_CRU_CONS_GATEID(i)	(16 * (i))
#define RK1108_CRU_GATEID_CONS(ID)	(RK1108_CRU_CLKGATE_CON\
	+ ((ID) / 16) * 4)

enum rk1108_cru_clk_gate {
	/* SCU CLK GATE 0 CON */
	RK1108_CLKGATE_UART0_SRC = (RK1108_CRU_CONS_GATEID(3) + 1),
	RK1108_CLKGATE_UART1_SRC = (RK1108_CRU_CONS_GATEID(3) + 3),
	RK1108_CLKGATE_UART2_SRC = (RK1108_CRU_CONS_GATEID(3) + 5),
	RK1108_CLKGATE_PCLK_UART0 = (RK1108_CRU_CONS_GATEID(13) + 10),
	RK1108_CLKGATE_PCLK_UART1,
	RK1108_CLKGATE_PCLK_UART2,
};

#define RK322XH_CRU_CRU_MODE		0x0080
#define RK322XH_CRU_GLB_RST_ST		0x0094
#define RK322XH_CRU_GLB_SRST_SND_VALUE	0x0098
#define RK322XH_CRU_GLB_SRST_FST_VALUE	0x009c

#define RK322XH_CRU_SDMMC_CON0		0x0380
#define RK322XH_CRU_SDMMC_CON1		0x0384
#define RK322XH_CRU_SDIO_CON0		0x0388
#define RK322XH_CRU_SDIO_CON1		0x038c
#define RK322XH_CRU_EMMC_CON0		0x0390
#define RK322XH_CRU_EMMC_CON1		0x0394
#define RK322XH_CRU_SDMMCEXT_CON0	0x0398
