...
enum pltfrm_cam_itf_type {
	...
	PLTFRM_CAM_ITF_CVBS_PAL	= 0x30000001,
	PLTFRM_CAM_ITF_CVBS_NTSC	= 0x30000002
};
...
#define PLTFRM_CAM_ITF_IS_CVBS(a)	\
	((a & PLTFRM_CAM_ITF_MAIN_MASK) == 0x30000000)
#define PLTFRM_CAM_ITF_IS_CVBS_PAL(a) \
	(PLTFRM_CAM_ITF_IS_CVBS(a) &&     \
		((a & PLTFRM_CAM_ITF_SUB_MASK) == 0x01))
#define PLTFRM_CAM_ITF_IS_CVBS_NTSC(a) \
	(PLTFRM_CAM_ITF_IS_CVBS(a) &&      \
		((a & PLTFRM_CAM_ITF_SUB_MASK) == 0x02))
