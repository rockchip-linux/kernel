...
#define SYS_STATUS_VIDEO_4K_60FPS	(1<<18)
#define SYS_STATUS_VIDEO_4K_10B_60FPS	(1<<19)

#define SYS_STATUS_VIDEO	(SYS_STATUS_VIDEO_4K|SYS_STATUS_VIDEO_1080P|\
				SYS_STATUS_VIDEO_4K_10B|SYS_STATUS_VIDEO_4K_60FPS|\
