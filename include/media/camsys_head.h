...
typedef enum camsys_mmap_type_e {
...
typedef struct camsys_devio_name_s {
	...
	unsigned int                dev_id;
	camsys_regulator_info_t     avdd;
	camsys_regulator_info_t     dovdd;
	camsys_regulator_info_t     dvdd;
	camsys_regulator_info_t     afvdd;
	camsys_gpio_info_t          pwrdn;
	camsys_gpio_info_t          rst;
	camsys_gpio_info_t          afpwr;
	camsys_gpio_info_t          afpwrdn;
	camsys_gpio_info_t          pwren;
